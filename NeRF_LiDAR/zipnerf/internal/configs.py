...
class Config:
    ...
    patch_size: int = 32  # Resolution of patches sampled for training batches.
    lidar_supervision: bool = False # use lidar supervision
    simulation_mode: str = 'simu'
    only_lidar_supervison: bool = False
    lidar_batch_ratio: int = 4 # ratio in batch size
    ...
    instance_obj: bool = False
    sensor_num: int = 6
    track_refine: bool = False
    track_start_opt: int = 5000
    tn_lr_init = 1e-4
    tn_lr_final = 1e-5
    use_semantic: bool = True
    semantic_dilate: bool = False
    latent_size: int = 0 # no latent vector
    latent_reg: float = 0.001
    simu_mode: str = 'replay'
    obj_nodecay: bool = False
    depth_loss: bool = True
    render_instance: bool = False
    sem_detach: bool = True
    half_vis: bool = False
    insert_track: str = 'obj_lib/tracks.npy'
    ignore_spec: bool = False # ignore some objects
    fuse_render: bool = False # fuse other vehicles
    aug_road: bool = False
